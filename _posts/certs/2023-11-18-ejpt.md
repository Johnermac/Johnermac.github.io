...
classes: single
header:  
  teaser: /assets/images/posts/nordic.jpg
  overlay_image: /assets/images/posts/nordic.jpg
  overlay_filter: 0.5
excerpt: "eLearnSecurity Junior Penetration Tester"
description: "INE Security’s eJPT is for entry-level Penetration testers that validates that the individual has the knowledge, skills, and abilities required to fulfill a role as a junior penetration tester."
categories:
  - certs
tags:
  - begginer
