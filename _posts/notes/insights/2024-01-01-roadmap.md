...
header:  
  ...
  overlay_filter: 0.5
excerpt: "How to be a Pentester"
description: "How to be a Pentester"
categories:
  - insights
tags:
  - tips
...
> *Nothing in this world is guaranteed*, but if you already worked in others IT jobs before, have some certifications and are showing your projects, github, etc in ur Linkedin You'll get a job sooner or later
...
What I want to say is: U'll get to a certain level that you'll need to choose a specialization path
...
- **50%** of the job is documentation
- Its a technical job, so u need to keep studying forever
- You must be at least a bit communicative, because of *debriefing*
